...
pout
loc = paste0("output/graphs/insulin_dist_time_",Sys.Date(),".png")
...
pout
loc = paste0("output/graphs/insulin_dy_",Sys.Date(),".png")
ggsave(loc,plot = pout)
...
loc = paste0("output/graphs/insulin_glucose_example_",Sys.Date(),".png")
ggsave(loc,plot = pout)
